...
public class Pedido {
    ...
    public Pedido(int nro, LocalDate fechaIngreso, LocalDate fechaEntrega, LocalDate fechaPago, int cantCajas, String domicilio, String qr, double importe, Revendedora revendedora, Campania campania, Vehiculo vehiculo) {
        this.nro = nro;
